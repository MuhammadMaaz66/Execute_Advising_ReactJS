        ...
        <div className="Demo" id="Demo">
            <div className="Container">
                <div className="col-1">
                    ...
                    <p>One Philosophy</p>
                    <p>Every single one of our financial advisors receive rigorous training according to John Doe's philosophy based on academic research (including that of a Nobel laureate in Economics) and Behavorial Finance.</p>
